...
- 本轮保留原 panorama manifest SHA-256：`8ecb6a5fc4990027c9fb8a1a91888e4a14478fa569a6cb14b1ec82a94633d7b0`。它相对于 Git HEAD 本来就是 dirty，不能将其回滚。
...
4. 飞船先读 r15 实图，继续改善大表面材质、仪表内容层次与结构可信度，保持驾驶位及天空可见性。
